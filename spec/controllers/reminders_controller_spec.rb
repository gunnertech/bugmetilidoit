  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reminder as @reminder" do
        ...
        post :create, {:reminder => { "assigned_task" => "invalid value" }}, valid_session
        assigns(:reminder).should be_a_new(Reminder)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reminder" do
        ...
        Reminder.any_instance.should_receive(:update_attributes).with({ "assigned_task" => "" })
        put :update, {:id => reminder.to_param, :reminder => { "assigned_task" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reminder as @reminder" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reminder.any_instance.stub(:save).and_return(false)
        put :update, {:id => reminder.to_param, :reminder => { "assigned_task" => "invalid value" }}, valid_session
        assigns(:reminder).should eq(reminder)
      end
